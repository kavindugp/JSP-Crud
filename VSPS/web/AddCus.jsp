...
<%@page import="comman.CusBean"%>
<%@page import="CRUD.ViewCus"%>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="card" style="margin-top: 4px;">
                <h3 style="text-align: center;margin-top: 10px;">Customer Handling</h3>
                <hr>
                <form action="controller/CusAddController.jsp">
                ...
                <div class="form-group" style="margin-left: 600px; margin-top: -230px;">
                  ...
                  <input type="text" style="width: 400px; height: 30px;" name="town" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Home Town" > 
                </div>
            ...
            <table border="1" style=" margin-left: 0px;width: 100% ; margin-top: 30px;">
               ...
               while(it_list.hasNext()){
                   ...
                   <tr>
                       ...
                       <td style="text-align: center"><button type="button" style="" onclick="location.href='controller/CusDeleteController.jsp?id=<%= obbean.getId()%>';" class="btn btn-danger">Delete</button></td>
                    </tr>
